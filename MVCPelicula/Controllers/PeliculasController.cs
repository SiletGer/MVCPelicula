...
namespace MVCPelicula.Controllers
{
    public class PeliculasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Titulo,FechaLanzamiento,Genero,Precio,Director,Sala")] Pelicula pelicula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Titulo,FechaLanzamiento,Genero,Precio,Director,Sala")] Pelicula pelicula)
        {
            if (id != pelicula.ID)
            {
                return NotFound();
